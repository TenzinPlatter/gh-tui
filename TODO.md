...
- [ ] add git worktree integration (will use a fzf process over all dirs in Repositories that have a .git dir (or maybe package.xml if i want to search by package?) and then create a worktree for it)
